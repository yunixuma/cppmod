...
/*   Updated: 2023/10/06 16:44:29 by ykosaka          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "DateConverter.hpp"

int	DateConverter::convert(std::string& str) {
...
// bool	DateConverter::forInt(std::stringstream& ss) {
bool	DateConverter::forInt(const std::string& str) {
	std::stringstream	ss;
	int					n;
...
bool	DateConverter::forChar(const std::string& str) {
	if (str.length() == 1) {
		char	c = str[0];
		display(c, \
...
// bool	DateConverter::forDouble(std::stringstream& ss) {
bool	DateConverter::forDouble(const std::string& str) {
	if (forPseudo(str)) {
...
bool	DateConverter::forFloat(const std::string& str) {
...
bool	DateConverter::forPseudo(const std::string& str) {
...
/*
bool	DateConverter::isPseudo(std::string& str) {
	if (str == STR_NAN || str == STR_INF || str == STR_INF_POS || str == STR_INF_NEG)
		return (true);
	return (false);
}
*/
void	DateConverter::display(const std::string& str, int flag) {
...
template <typename T>
void	DateConverter::display(T scalar, int flag) {
...
/*
bool	DateConverter::isInt(std::string& str) {
	std::stringstream	ss;
	int					n;
...
RET	DateConverter::convert(std::string& str) {
	RET			ret;
	std::stringstream	ss;
	ss << str;
	ss >> ret;
...
/*
template<>
char<RET>	DateConverter::convert<char>(std::string& str) {
	char			c;
	stringstream	ss;
	ss << str;
	ss >> c;
...
template<>	DateConverter::convert float(std::string& str) {
	return (1.5);
}

template<>	DateConverter::convert double(std::string& str) {
	return (1.5);
}

// template<class T>
// static char DateConverter::convert(std::string& str) {
// 	if (str.length != 1)
// 		return ('!');
// 	return (*str.c_str());
// }
...
std::string	DateConverter::convert(const std::string& str) {
	 std::clog << "\033[32;2;3m<DateConverter> toInt() called (" \
		<< str << ")\033[m" << std::endl;
	return (str);
}

std::string	DateConverter::toChar(const std::string& str) {
	 std::clog << "\033[32;2;3m<DateConverter> toChar() called (" \
		<< str << ")\033[m" << std::endl;
	return (str);
}

std::string	DateConverter::toFloat(const std::string& str) {
	 std::clog << "\033[32;2;3m<DateConverter> toFloat() called (" \
		<< str << ")\033[m" << std::endl;
	return (str);
}

std::string	DateConverter::toDouble(const std::string& str) {
	 std::clog << "\033[32;2;3m<DateConverter> toDouble() called (" \
		<< str << ")\033[m" << std::endl;
	return (str);
}
*/